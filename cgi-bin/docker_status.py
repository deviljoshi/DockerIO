...
#	print(c_details)	
	...
	<td>{}</td>
	<td>{}</td>
	<td><a href='http://192.168.43.80/cgi-bin/docker_start.py?s={}'>Start</a></td>
	<td><a href='http://192.168.43.80/cgi-bin/docker_stop.py?s={}'>Stop</a></td>
	<td><a href='http://192.168.43.80/cgi-bin/docker_terminate.py?s={}'>Terminate</a></td>'''.format(cname, imagename, cstatus, cname, cname, cname ))
	#print(c_details[-2])	
...
#		print(x[1])
	...
	#	print(y)
		port=y.split('-')[0]
		print("<td><a target='myconsole' href='https://192.168.43.80:{}'>Console</a></td>".format(port))
		print("</tr>")
